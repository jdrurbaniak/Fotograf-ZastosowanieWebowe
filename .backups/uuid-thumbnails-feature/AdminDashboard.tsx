...
import { getAlbums, createAlbum, updateAlbum, deleteAlbum, getPhotos, uploadPhoto, updatePhoto, deletePhoto } from '../services/api';
...
const AdminDashboard = () => {
  ...
  const handlePhotoUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Nie udało się przesłać niektórych zdjęć');
    } finally {
      setUploading(false);
    }
  };
